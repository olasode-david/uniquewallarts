    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('billing.update',$details->id)}}">
                        @csrf
                        @method("PUT")
                            ...
                            <div class="col-md-6">
                                <input id="street" type="text" name="street"
                                 class="form-control mb-2 @error('street') is-invalid @enderror text-secondary text-small" 
                                  value="{{ $details->street }}" placeholder="House number and street name"
                                  required>
                                ...
                                @enderror
                                 ...
                                 name="apartment" value="{{ $details->apartment }}" 
                        ...
                        <div class="form-group row">
                            ...
                            Your current <strong>state: {{$details->state}}</strong>
                            </div>
                        <div class="form-group row">
                            <label for="state"
                             class="col-md-4 col-form-label text-md-right">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="postcode" value="{{$details->postcode}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" value="{{$details->phone}}"
